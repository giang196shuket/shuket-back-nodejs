...
module.exports = class productBarcodeModel {
  ...
  WHERE MIP.IM_BARCODE IS NULL ${where}  ${limitQuery}`

  const sqlCount = ' SELECT COUNT(SEQ) AS CNT FROM moa_platform.TBL_MOA_IMAGE_PRD  WHERE IM_BARCODE IS NULL'
